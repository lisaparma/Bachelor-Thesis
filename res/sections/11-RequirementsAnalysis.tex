...
Considerando l'obbiettivo del progetto spiegato nella sezione \ref{sec:intaz}, i casi d'uso (come i requisiti funzionali) sono stati sviluppati e modificati durante tutto il corso del progetto\note{potresti anche mettere che è anche dovuto al metodo di lavoro adottato}. In questa sezione vengono riportati e descritti i casi d'uso principali che sono stati delineati fin da subito tramite le richieste dell'azienda e quelli di alto livello, in modo da poter dare una visione d’insieme più precisa del prodotto sviluppato.
...
\begin{itemize}
	\item La R sta per requisito ed è presente in tutti i codici\note{stona un po' rispetto alla formalità delle altre descrizioni, potresti mettere \emph{la ``R'' identifica i codici dei requisiti} oppure \emph{``R'', per requisito, è prefisso di tutti i codici dei requisiti} o qualcosa di simile};
