...
\note{Si potrebbe dare un po' di contesto alla frase, tipo:\emph{Durante
l'analisi dei requisiti, studiando i vari scenari, sono stati individuati
quattro attori attivi, dei quali tre sono attori principali, mentre uno è un
attore secondario.} Inoltre se hai partecipato all'analisi non sarebbe male
definire il tuo ruolo all'inizio del capitolo.}
\subsection{Attori principali}
\subsubsection{Utente Zimbra}
L'applicazione è destinata solamente agli \emph{utenti Zimbra}. \mmh{si traduce
nel fatto che si puo\'}{potresti cambiare in \emph{implica che si possa}}
