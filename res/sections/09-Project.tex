...
Tale prodotto è stato sviluppato utilizzando il \gl{framework}{framework} \emph{React Native}, ed è stato reso disponibile sia per sistemi \gl{Android}{Android} che \gl{iOS}{iOS}.
