...
Per sviluppare l'applicazione \emph{Teamwork} è stato utilizzato \emph{Docker 18.03 Community Edition} per \emph{Ubuntu Bionic}. In questo modo si è potuto istanziare nelle macchine locali un \emph{container} di \emph{Zimbra} e del \emph{core Zextras} con la \emph{zimlet OpenChat} caricata così da sviluppare l'applicativo in un ambiente sicuro e pulito.
...
\subsubsection{Flux} \label{subsubsec:flux}
 ...
 \end{figure}
 Il flusso parte da degli oggetti \emph{stores}, che contengono i dati dell'applicazione che vengono forniti ai componenti dell'applicazione in modo che la view sia sempre aggiornata con questi dati. \\
...
Native. Si basa sul remote debugger disponibile quando si monitora un progetto 
