...
Questa società è nata nel 2011 con l'obbiettivo di espandere le possibilità della suite di prodotti di collaborazione Zimbra (sez. \ref{subsec:Zimbra}): ha dato vita così a Zextras Suite (sez. \ref{subsec:Zextras}), una serie di prodotti che migliorano i servizi Zimbra e offrono funzionalità importanti per un uso lavorativo del software.
