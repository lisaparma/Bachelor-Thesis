...
Questa società è nata nel 2011 con l'obbiettivo di espandere le possibilità della \mmh{collaboration suite Zimbra}{cos'è? dico qui due paroline anche? Io metterei un riferimento alla sezione sotto e basta}.
In pochi anni è riuscita a rendere la propria suite di prodotti l'estensione professionale per Zimbra Open Source più avanzata tra le soluzioni di collaborazione sul mercato. I loro prodotti sono riconosciuti come ottimali anche dalla \mmh{community Zimbra}{Avrà u nome no? Ho cercato ma non ho trovato un nome. Al massimo potresti mettere ``community di utenti che utillizzano i software Zimbra''} e ciò ha portato ad una collaborazione per lo sviluppo di alcuni prodotti open source e per Zimbra Suite Plus.
...
\end{itemize}
\note{i pilatri non sono scritti molto in italiano:\\
- gli individui e le interazioni sono più importanti dei processi e degli strumenti;\\
- è più importante avere del software funzionante rispetto ad avere una documentazione esaustiva;\\
- è più importante la collaborazio col cliente che il rispetto dei contratti;\\
...
\subsubsection{BitBucket}\note{Non ho capito perché hai messo come sezione solo Bitbucket se parli anche di github, puoi accennare al fatto anche che lo utilizzavi anche tu (come negli altri strumenti nel caso)}
Per il versionamento del software Uqido S.r.l. utilizza Git, affidandosi a GitHub
e a BitBuket come \mmh{host}{servizi di hosting metterei} (entrambi gratuiti) per i progetti in corso
di sviluppo.
\subsubsection{Jira}\note{Jira e parli di basecamp}
